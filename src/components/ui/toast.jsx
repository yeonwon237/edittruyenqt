...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/60 transition-colors hover:text-foreground hover:bg-foreground/10 focus:outline-none focus:ring-2 group-[.destructive]:text-red-100 group-[.destructive]:hover:text-red-50 group-[.destructive]:hover:bg-red-700/30",
      className
    )}
    toast-close=""
    {...props}
